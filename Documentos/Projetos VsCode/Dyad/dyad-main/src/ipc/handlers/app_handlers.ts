...
const DEFAULT_EXPO_COMMAND =
  "(pnpm install && EXPO_NO_INTERACTIVE=1 pnpm exec expo start --web --port 32100) || (npm install --legacy-peer-deps && EXPO_NO_INTERACTIVE=1 npx expo start --web --port 32100)";
